...
public class Mobility extends Skill {
    public Mobility() {
        super("Mobility", XMaterial.LEATHER_BOOTS.parseMaterial(),
                Arrays.asList("&7- Bonus movement speed on water [calc(%mobility_attribute_movement%*%level%)%]",
                        "&7- Apply haste potion with level calc(%mobility_attribute_efficiency%+1) [calc(%mobility_attribute_efficiency-duration%*%level%) second(s)]"), 25);
